...
{ a real time data visualisation routine - multiple window version.                        }
{                                                                                          }
...
DEFER ClassName_2  :NONAME   Z" Multi_BMP_2" ;   IS ClassName_2

DEFER AppTitle_1 :NONAME   Z"  BMP Window 1" ;   IS AppTitle_1

DEFER AppTitle_2 :NONAME   Z"  BMP Window 2" ;   IS AppTitle_2
...
[SWITCH AppMessages_2 DEFWINPROC ( msg -- res ) WM_DESTROY RUNS ENDAPP_2 SWITCH]


:NONAME ( -- res ) MSG LOWORD AppMessages_1 ; 4 CB: APP-WNDPROC_1

:NONAME ( -- res ) MSG LOWORD AppMessages_2 ; 4 CB: APP-WNDPROC_2
...
: /APP-WINDOW_2 ( -- hwnd )
   0 TO hApp_2
      0                                 \ extended style
      ClassName_2                       \ window class name
      AppTitle_2                        \ window caption
      WS_OVERLAPPEDWINDOW
      80 120                            \ Window top left corner
      BMP_x_size 10 +
      BMP_y_size 30 +                   \ position and size
      0                                 \ parent window handle
      0                                 \ window menu handle
...
: AppStart_2 ( -- hwnd )
   hApp_2 ?EXIT /APP-CLASS_2 /APP-WINDOW_2 ;
...
[+SWITCH AppMessages_2
   WM_CREATE  RUNS BMP-CREATE   
   WM_TIMER   RUNS BMP_Window_Update_2
SWITCH]
...
make-memory-bmp
Random_BMP_Blue
bmp-address @ bmp-address_2 !


: Random_BMPs
  begin
  bmp-address_1 @ bmp-address ! Random_BMP_Red
  bmp-address_2 @ bmp-address ! Random_BMP_Green
